...
use Becas\HackControlFBundle\Entity\Detalle;
use Becas\HackControlFBundle\Form\DetalleType;
...
class DetalleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BecasHackControlFBundle:Detalle')->findAll();
     ...
     *
     * @Route("/", name="detalle_create")
     * @Method("POST")
     * @Template("BecasHackControlFBundle:Detalle:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BecasHackControlFBundle:Detalle')->find($id);
     ...
     *
     * @Route("/{id}", name="detalle_update")
     * @Method("PUT")
     * @Template("BecasHackControlFBundle:Detalle:edit.html.twig")
     */
