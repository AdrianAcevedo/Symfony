...
use Becas\HackControlFBundle\Entity\Cliente;
use Becas\HackControlFBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BecasHackControlFBundle:Cliente')->findAll();
     ...
     * @Method("POST")
     * @Template("BecasHackControlFBundle:Cliente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BecasHackControlFBundle:Cliente')->find($id);
     ...
     * @Method("PUT")
     * @Template("BecasHackControlFBundle:Cliente:edit.html.twig")
     */
