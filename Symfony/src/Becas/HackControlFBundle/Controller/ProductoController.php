...
use Becas\HackControlFBundle\Entity\Producto;
use Becas\HackControlFBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BecasHackControlFBundle:Producto')->findAll();
     ...
     * @Method("POST")
     * @Template("BecasHackControlFBundle:Producto:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BecasHackControlFBundle:Producto')->find($id);
     ...
     * @Method("PUT")
     * @Template("BecasHackControlFBundle:Producto:edit.html.twig")
     */
